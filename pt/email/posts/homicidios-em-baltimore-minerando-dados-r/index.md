# [Extraindo dados de texto com regex no R](https://phelipetls.github.io/pt/posts/homicidios-em-baltimore-minerando-dados-r/)

April 01, 2019 · 8 min. read time
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="c1"># note que, no r, precisamos infelizmente</span>
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">lat_long</span> <span class="o">&lt;-</span> <span class="nf">str_match</span><span class="p">(</span>
  <span class="n">homicides</span><span class="p">,</span>
...
Daí que:</p>
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">raca</span> <span class="o">&lt;-</span> <span class="nf">str_match</span><span class="p">(</span>
  <span class="n">homicides</span><span class="p">,</span>
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">raca</span> <span class="o">%&gt;%</span> <span class="nf">tail</span><span class="p">()</span>
</code></pre></div><pre><code>##         [,1]          [,2] [,3] [,4]
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">genero</span> <span class="o">&lt;-</span> <span class="nf">str_match</span><span class="p">(</span>
  <span class="n">homicides</span><span class="p">,</span>
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">genero</span> <span class="o">%&gt;%</span> <span class="nf">tail</span><span class="p">()</span>
</code></pre></div><pre><code>##         [,1]             [,2] [,3]
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">idade</span> <span class="o">&lt;-</span> <span class="nf">str_match</span><span class="p">(</span>
  <span class="n">homicides</span><span class="p">,</span>
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">idade</span> <span class="o">%&gt;%</span> <span class="nf">tail</span><span class="p">()</span>
</code></pre></div><pre><code>##         [,1]      [,2] [,3]
## [1245,] &quot;Age: 30&quot; NA   &quot;30&quot;
## [1246,] &quot;Age: 35&quot; NA   &quot;35&quot;
## [1247,] &quot;Age: 27&quot; NA   &quot;27&quot;
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">data</span> <span class="o">&lt;-</span> <span class="nf">str_match</span><span class="p">(</span>
  <span class="n">homicides</span><span class="p">,</span>
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">endereco</span> <span class="o">&lt;-</span> <span class="nf">str_match</span><span class="p">(</span>
  <span class="n">homicides</span><span class="p">,</span>
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">causas</span> <span class="o">&lt;-</span> <span class="n">causes[</span><span class="p">,</span> <span class="m">2</span><span class="n">]</span>
...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-r" data-lang="r"><span class="n">homicides_df</span> <span class="o">&lt;-</span> <span class="n">homicides_df</span> <span class="o">%&gt;%</span>
